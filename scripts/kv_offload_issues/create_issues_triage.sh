...
declare -A TITLE=(
  ...
  [M1P1]="[M1-P1] Prereq: reproducible custom-built flex + torch-spyre + spyre-inference env"
  ...
  [M2F3]="[M2-F3] Hardware runtime: copyRaw multi-chunk (1p5) + cross-process slot round-trip"
